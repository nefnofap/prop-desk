...
// Lowered to surface role-player threes/rebounds; still high enough to skip 0.5-noise on non-contributors.
const BOOK_MIN_LINE = {
...
export function isPropCandidate(logs, window) {
  ...
  // Lowered slightly so more rotation players qualify (was 18 min / 8 pts)
